    ...
    def compute_SSA(self, cfg):
        ...
        for block in all_blocks:
            ...
            for i in range(n_stmts):
                ...
                # it first deals with variables on the left hand side of the
                # assignment, which will cause wrong 'ident_name_counter' for
                # the same variable that appears on the right hand side.
